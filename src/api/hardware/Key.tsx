      ...
      {keyType == "regularKey" ? (
        ...
        >
          <g className="shadowHover">
            <rect x={x} y={y + 4} width={width} height={height} rx="4" fill={`var(--bazecor-key-color-fill, ${color})`} />
          </g>
          <g className="baseShape">
            <rect x={x} y={y} width={width} height={height} rx="4" fill="var(--bazecor-key-outer-fill, #303949)" />
            ...
            <rect
              ...
              height={height}
              rx="4"
              fill={`var(--bazecor-key-color-fill, ${color})`}
            ...
            <rect
              ...
              stroke={`var(--bazecor-key-stroke-color, ${color})`}
              strokeWidth="2"
              fill="transparent"
            />
          </g>
      ...
      {keyType == "t5" ? (
        ...
        >
          ...
          <g className="baseShape">
            <path
              d="M1.37773 4.98057C-0.325982 3.04224 1.05038 0 3.63103 0H115C117.209 0 119 1.79086 119 4V53C119 55.2091 117.209 57 115 57H49.8154C48.0899 57 46.4479 56.2571 45.3088 54.9611L1.37773 4.98057Z"
              fill="var(--bazecor-key-outer-fill, #303949)"
            />
            <path
              d="M1.37773 4.98057C-0.325982 3.04224 1.05038 0 3.63103 0H115C117.209 0 119 1.79086 119 4V53C119 55.2091 117.209 57 115 57H49.8154C48.0899 57 46.4479 56.2571 45.3088 54.9611L1.37773 4.98057Z"
              fill={`url(#paintGradient${id})`}
